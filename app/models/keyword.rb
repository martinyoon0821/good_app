...
class Keyword < ApplicationRecord
    ...
    def get_crawl(place)
        ...
        instagram_url = "https://www.instagram.com/explore/tags/#{place}"
        ...
        location_arr.each do |l|
            ...
            title_data = @browser.find_element(xpath: "/html/body/div[1]/section/main/article/header/div[2]/h1")
            ...
            lat = lat
            lng = lng
            self.locations.create(title: title, lat: lat, lng: lng)
            rescue
                next
            end
        @browser.quit
    ...
    def get_markers
        self.locations.map.with_index {|l, i| [l.title, l.lat, l.lng, i + 1]}
    end
end
